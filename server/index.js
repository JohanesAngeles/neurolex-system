...
if (isProduction) {
  ...
  // Set environment variables to disable AI training
...
const authLimiter = rateLimit({
  windowMs: 15 * 60 * 1000,
  max: isProduction ? 50 : 100, // Lower limit in production for memory
...
if (apiRoutes) {
  ...
  console.log('✅ Central API routes mounted');
}
  ...
  connectMaster()
    ...
    .then(() => {
      ...
      server.listen(PORT, '0.0.0.0', () => {
        ...
        console.log('✅ Journal & Mood Tracking');
