// server/src/routes/appointmentRoutes.js - SIMPLIFIED VERSION
...
console.log('Loading simplified appointment routes...');
...
// Accept appointment (basic version)
...
console.log('Simplified appointment routes loaded successfully');
